...
# ---------------------------------------------------------------------------
# Issue 2: CrisisAlphaConfig — REMOVED 2026-06-11
#
# prometheus/sector/crisis_alpha.py was dead code (imported only by tests,
# never by the live pipeline) and was deleted in the signal-layer cleanup.
# The live "crisis_alpha" options strategy lives in
# prometheus/execution/options_strategy.py and is unrelated to this module.
# ---------------------------------------------------------------------------
