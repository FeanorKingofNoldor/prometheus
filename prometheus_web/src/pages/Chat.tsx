...
import { useIrisChat } from "../api/hooks";
...
export default function Chat() {
  ...
  return (
    <div className="flex h-full flex-col">
      <PageHeader title="Iris" subtitle="AI assistant" />
          ...
          {chat.isPending && (
            <div className="flex justify-start">
              <div className="rounded-lg bg-surface-overlay px-4 py-2.5">
                <div className="mb-1 text-[10px] font-semibold uppercase tracking-wider text-accent">Iris</div>
